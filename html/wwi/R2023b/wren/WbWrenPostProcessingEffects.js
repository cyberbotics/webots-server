...
export default class WbWrenPostProcessingEffects {
  static bloom(width, height, textureFormat) {
    ...
    _wr_post_processing_effect_set_drawing_index(
      bloomEffect,
      WbWrenRenderingContext.PP_BLOOM
    );
    ...
    Module.ccall(
      ...
      null,
      ['number', 'string'],
      [colorPassThrough, 'colorPassThrough']
    );
    _wr_post_processing_effect_pass_set_program(
      colorPassThrough,
      WbWrenShaders.passThroughShader()
    );
    _wr_post_processing_effect_pass_set_output_size(
      colorPassThrough,
      width,
      height
    );
    _wr_post_processing_effect_pass_set_alpha_blending(colorPassThrough, false);
    _wr_post_processing_effect_pass_set_input_texture_count(
      colorPassThrough,
      1
    );
    _wr_post_processing_effect_pass_set_output_texture_count(
      colorPassThrough,
      1
    );
    _wr_post_processing_effect_pass_set_output_texture_format(
      colorPassThrough,
      0,
      textureFormat
    );
    ...
    _wr_post_processing_effect_pass_set_input_texture_wrap_mode(
      brightPass,
      0,
      Enum.WR_TEXTURE_WRAP_MODE_CLAMP_TO_EDGE
    );
    _wr_post_processing_effect_pass_set_output_texture_format(
      brightPass,
      0,
    ...
    for (let i = 0; i < 6; ++i) {
      ...
      _wr_post_processing_effect_pass_set_input_texture_interpolation(
        blurPass,
        0,
        true
      );
    ...
    _wr_post_processing_effect_connect(
      bloomEffect,
      colorPassThrough,
      0,
      blendPass,
    ...
    _wr_post_processing_effect_set_result_program(
      bloomEffect,
      WbWrenShaders.passThroughShader()
    );
    return bloomEffect;
  ...
  static gtao(
    ...
    _wr_post_processing_effect_set_drawing_index(
      gtaoEffect,
      WbWrenRenderingContext.PP_GTAO
    );
    ...
    if (halfRes) {
      ...
      _wr_post_processing_effect_pass_set_alpha_blending(
        depthDownsamplePassThrough,
        false
      );
      _wr_post_processing_effect_pass_set_input_texture(
        depthDownsamplePassThrough,
        0,
        depthTexture
      );
      ...
      _wr_post_processing_effect_append_pass(
        gtaoEffect,
        depthDownsamplePassThrough
      );
    ...
    Module.ccall(
      ...
      null,
      ['number', 'string'],
      [gtaoForwardPass, 'gtaoForwardPass']
    );
    _wr_post_processing_effect_pass_set_program(
      gtaoForwardPass,
    ...
    _wr_post_processing_effect_pass_set_input_texture(
      gtaoForwardPass,
      2,
      WbWrenPostProcessingEffects.gtaoNoiseTexture
    );
    _wr_post_processing_effect_pass_set_input_texture_wrap_mode(
      gtaoForwardPass,
      0,
    ...
    _wr_post_processing_effect_pass_set_clear_before_draw(
      gtaoForwardPass,
      true
    );
    ...
    _wr_post_processing_effect_pass_set_output_texture_format(
      gtaoForwardPass,
      0,
      Enum.WR_TEXTURE_INTERNAL_FORMAT_RED
    );
  ...
  static loadResources(smaaAreaTexture, smaaSearchTexture, gtaoNoiseTexture) {
    WbWrenPostProcessingEffects.smaaAreaTexture = WbWrenPostProcessingEffects.loadImage(
      smaaAreaTexture
    );
    WbWrenPostProcessingEffects.smaaSearchTexture = WbWrenPostProcessingEffects.loadImage(
      smaaSearchTexture
    );
    WbWrenPostProcessingEffects.gtaoNoiseTexture = WbWrenPostProcessingEffects.loadImage(
      gtaoNoiseTexture
    );
  }
  ...
  static loadImage(image) {
    ...
    Module.ccall(
      'wr_texture_2d_set_file_path',
      null,
      ['number', 'string'],
      [targetTexture, image.url]
    );
  ...
  static smaa(width, height, textureFormat) {
    ...
    _wr_post_processing_effect_set_drawing_index(
      smaaEffect,
      WbWrenRenderingContext.PP_SMAA
    );
    ...
    Module.ccall(
      ...
      null,
      ['number', 'string'],
      [passThrough, 'LensFlarePassToBlend']
    );
    _wr_post_processing_effect_pass_set_program(
      passThrough,
      WbWrenShaders.passThroughShader()
    ...
    _wr_post_processing_effect_pass_set_output_texture_format(
      passThrough,
      0,
      Enum.WR_TEXTURE_INTERNAL_FORMAT_RGBA8
    );
    ...
    _wr_post_processing_effect_pass_set_output_texture_format(
      edgeDetection,
      0,
      Enum.WR_TEXTURE_INTERNAL_FORMAT_RG8
    );
    ...
    _wr_post_processing_effect_pass_set_input_texture(
      weightCalculation,
      1,
      WbWrenPostProcessingEffects.smaaAreaTexture
    );
    _wr_post_processing_effect_pass_set_input_texture(
      weightCalculation,
      2,
      WbWrenPostProcessingEffects.smaaSearchTexture
    );
    _wr_post_processing_effect_pass_set_input_texture_interpolation(
      weightCalculation,
      2,
    ...
    _wr_post_processing_effect_pass_set_output_texture_format(
      finalBlend,
      0,
      Enum.WR_TEXTURE_INTERNAL_FORMAT_RGB8
    );
