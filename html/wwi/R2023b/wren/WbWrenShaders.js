...
export default class WbWrenShaders {
  static buildShader(shader, vertexShaderPath, fragmentShaderpath) {
    Module.ccall(
      'wr_shader_program_set_vertex_shader_path',
      null,
      ['number', 'string'],
      [shader, vertexShaderPath]
    );
    Module.ccall(
      'wr_shader_program_set_fragment_shader_path',
      null,
      ['number', 'string'],
    ...
    if (!_wr_shader_program_get_gl_name(shader)) {
      ...
      if (_wr_shader_program_has_vertex_shader_compilation_failed(shader))
        ...
        _wr_shader_program_has_fragment_shader_compilation_failed(shader)
      )
        console.error('Fragment shader compilation failed');
      else console.error('Linkage failed');
    }
  }
  ...
  static bloomBlendShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_BLOOM_BLEND]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_BLOOM_BLEND
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_BLOOM_BLEND],
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_BLOOM_BLEND],
        '../../../resources/wren/shaders/pass_through.vert',
        '../../../resources/wren/shaders/blend_bloom.frag'
      );
    }
  ...
  static brightPassShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_BRIGHT_PASS]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_BRIGHT_PASS
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_BRIGHT_PASS],
        Enum.WR_GLSL_LAYOUT_UNIFORM_TEXTURE0
      );
      ...
      Module.ccall(
        ...
        [
          WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_BRIGHT_PASS],
          'threshold',
          Enum.WR_SHADER_PROGRAM_UNIFORM_TYPE_FLOAT,
          defaultThresholdPointer,
        ]
      );
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_BRIGHT_PASS],
        '../../../resources/wren/shaders/pass_through.vert',
        '../../../resources/wren/shaders/bright_pass.frag'
      );
    }
  ...
  static defaultShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_DEFAULT]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_DEFAULT
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_DEFAULT],
        Enum.WR_GLSL_LAYOUT_UNIFORM_TEXTURE0
      ); // main texture
      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_DEFAULT],
      ...
      _wr_shader_program_use_uniform_buffer(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_DEFAULT],
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_DEFAULT],
        '../../../resources/wren/shaders/default.vert',
        '../../../resources/wren/shaders/default.frag'
      );
    }
  ...
  static depthPixelShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_DEPTH_PIXEL]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_DEPTH_PIXEL
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_DEPTH_PIXEL],
        Enum.WR_GLSL_LAYOUT_UNIFORM_MODEL_TRANSFORM
      );
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_DEPTH_PIXEL],
        '../../../resources/wren/shaders/web_depth.vert',
        '../../../resources/wren/shaders/web_depth.frag'
      );
    }
  ...
  static fogShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_FOG]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_FOG
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_FOG],
        Enum.WR_GLSL_LAYOUT_UNIFORM_MODEL_TRANSFORM
      );
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_FOG],
        '../../../resources/wren/shaders/fog.vert',
        '../../../resources/wren/shaders/fog.frag'
      );
    }
  ...
  static gaussianBlur13TapShader() {
    if (
      !WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_GAUSSIAN_BLUR_13_TAP]
    ) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_GAUSSIAN_BLUR_13_TAP
      ] = _wr_shader_program_new();
      ...
      WbWrenShaders.buildShader(
        ...
        '../../../resources/wren/shaders/pass_through.vert',
        '../../../resources/wren/shaders/gaussian_blur_13_tap.frag'
      );
    }

    return WbWrenShaders.gShaders[
      WbWrenShaders.SHADER.SHADER_GAUSSIAN_BLUR_13_TAP
    ];
  }
  ...
  static gtaoShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_GTAO]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_GTAO
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_GTAO],
        Enum.WR_GLSL_LAYOUT_UNIFORM_TEXTURE0
      );
      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_GTAO],
      ...
      Module.ccall(
        ...
        [
          WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_GTAO],
          'params',
          Enum.WR_SHADER_PROGRAM_UNIFORM_TYPE_VEC4F,
          paramsPointer,
        ]
      );
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_GTAO],
        '../../../resources/wren/shaders/pass_through.vert',
        '../../../resources/wren/shaders/gtao.frag'
      );
    }
  ...
  static gtaoSpatialDenoiseShader() {
    if (
      !WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_GTAO_SPATIAL_DENOISE]
    ) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_GTAO_SPATIAL_DENOISE
      ] = _wr_shader_program_new();
      ...
      WbWrenShaders.buildShader(
        ...
        '../../../resources/wren/shaders/pass_through.vert',
        '../../../resources/wren/shaders/gtao_spatial_denoise.frag'
      );
    }
  ...
  static gtaoTemporalDenoiseShader() {
    if (
      !WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_GTAO_TEMPORAL_DENOISE]
    ) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_GTAO_TEMPORAL_DENOISE
      ] = _wr_shader_program_new();
      ...
      const previousInverseViewMatrixPointer = arrayXPointer(
      ...
      Module.ccall(
        ...
        [
          ...
          'previousInverseViewMatrix',
          Enum.WR_SHADER_PROGRAM_UNIFORM_TYPE_MAT4F,
      ...
      WbWrenShaders.buildShader(
        ...
        '../../../resources/wren/shaders/pass_through.vert',
        '../../../resources/wren/shaders/gtao_temporal_denoise.frag'
      );
    }
  ...
  static gtaoCombineShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_GTAO_COMBINE]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_GTAO_COMBINE
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_GTAO_COMBINE],
        0
      );
      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_GTAO_COMBINE],
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_GTAO_COMBINE],
        '../../../resources/wren/shaders/pass_through.vert',
        '../../../resources/wren/shaders/gtao_combine.frag'
      );
    }
  ...
  static hdrClearShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_HDR_CLEAR]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_HDR_CLEAR
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform_buffer(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_HDR_CLEAR],
        Enum.WR_GLSL_LAYOUT_UNIFORM_BUFFER_MATERIAL_PHONG
      );
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_HDR_CLEAR],
        '../../../resources/wren/shaders/pass_through.vert',
        '../../../resources/wren/shaders/hdr_clear.frag'
      );
    }
  ...
  static hdrResolveShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_HDR_RESOLVE]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_HDR_RESOLVE
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_HDR_RESOLVE],
        Enum.WR_GLSL_LAYOUT_UNIFORM_TEXTURE0
      );
      ...
      Module.ccall(
        ...
        [
          ...
          'exposure',
          Enum.WR_SHADER_PROGRAM_UNIFORM_TYPE_FLOAT,
          _wrjs_pointerOnFloat(defaultExposureValue),
        ]
      );
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_HDR_RESOLVE],
        '../../../resources/wren/shaders/pass_through.vert',
        '../../../resources/wren/shaders/hdr_resolve.frag'
      );
    }
  ...
  static iblSpecularIrradianceBakingShader() {
    if (
      !WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_IBL_SPECULAR_IRRADIANCE_BAKE
      ]
    ) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_IBL_SPECULAR_IRRADIANCE_BAKE
      ...
      const projectionAndViewDefaultsPointer = arrayXPointer(
        projectionAndViewDefaults
      );
      Module.ccall(
        'wr_shader_program_create_custom_uniform',
        null,
        ...
        [
          ...
          'projection',
          Enum.WR_SHADER_PROGRAM_UNIFORM_TYPE_MAT4F,
          projectionAndViewDefaultsPointer,
        ]
      );
      Module.ccall(
        'wr_shader_program_create_custom_uniform',
      ...
      Module.ccall(
        ...
        [
          ...
          'roughness',
          Enum.WR_SHADER_PROGRAM_UNIFORM_TYPE_FLOAT,
          _wrjs_pointerOnFloat(roughness),
        ]
      );
      ...
      WbWrenShaders.buildShader(
        ...
        '../../../resources/wren/shaders/bake_cubemap.vert',
        '../../../resources/wren/shaders/bake_specular_cubemap.frag'
      );
    }
  ...
  static iblBrdfBakingShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_IBL_BRDF_BAKE]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_IBL_BRDF_BAKE
      ] = _wr_shader_program_new();

      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_IBL_BRDF_BAKE],
        '../../../resources/wren/shaders/bake_brdf.vert',
        '../../../resources/wren/shaders/bake_brdf.frag'
      );
    }
  ...
  static lineSetShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_LINE_SET]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_LINE_SET
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_LINE_SET],
        Enum.WR_GLSL_LAYOUT_UNIFORM_MODEL_TRANSFORM
      );
      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_LINE_SET],
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_LINE_SET],
        '../../../resources/wren/shaders/line_set.vert',
        '../../../resources/wren/shaders/line_set.frag'
      );
    }
  ...
  static passThroughShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PASS_THROUGH]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_PASS_THROUGH
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PASS_THROUGH],
        Enum.WR_GLSL_LAYOUT_UNIFORM_TEXTURE0
      );
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PASS_THROUGH],
        '../../../resources/wren/shaders/pass_through.vert',
        '../../../resources/wren/shaders/pass_through.frag'
      );
    }
  ...
  static pbrShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PBR]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_PBR
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PBR],
        Enum.WR_GLSL_LAYOUT_UNIFORM_TEXTURE0
      ); // base color texture
      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PBR],
      ...
      Module.ccall(
        ...
        [
          WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PBR],
          'reverseNormals',
          Enum.WR_SHADER_PROGRAM_UNIFORM_TYPE_BOOL,
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PBR],
        '../../../resources/wren/shaders/pbr.vert',
        '../../../resources/wren/shaders/pbr.frag'
      );
    }
  ...
  static pbrStencilAmbientEmissiveShader() {
    if (
      !WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_PBR_STENCIL_AMBIENT_EMISSIVE
      ]
    ) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_PBR_STENCIL_AMBIENT_EMISSIVE
  ...
  static pbrStencilDiffuseSpecularShader() {
    if (
      !WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_PBR_STENCIL_DIFFUSE_SPECULAR
      ]
    ) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_PBR_STENCIL_DIFFUSE_SPECULAR
  ...
  static phongShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PHONG]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_PHONG
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PHONG],
        Enum.WR_GLSL_LAYOUT_UNIFORM_TEXTURE0
      ); // main texture
      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PHONG],
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PHONG],
        '../../../resources/wren/shaders/phong.vert',
        '../../../resources/wren/shaders/phong.frag'
      );
    }
  ...
  static phongStencilAmbientEmissiveShader() {
    if (
      !WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_PHONG_STENCIL_AMBIENT_EMISSIVE
      ]
    ) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_PHONG_STENCIL_AMBIENT_EMISSIVE
  ...
  static phongStencilDiffuseSpecularShader() {
    if (
      !WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_PHONG_STENCIL_DIFFUSE_SPECULAR
      ]
    ) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_PHONG_STENCIL_DIFFUSE_SPECULAR
  ...
  static pickingShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PICKING]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_PICKING
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PICKING],
        Enum.WR_GLSL_LAYOUT_UNIFORM_MODEL_TRANSFORM
      );
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_PICKING],
        '../../../resources/wren/shaders/picking.vert',
        '../../../resources/wren/shaders/picking.frag'
      );
    }
  ...
  static pointSetShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_POINT_SET]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_POINT_SET
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_POINT_SET],
        Enum.WR_GLSL_LAYOUT_UNIFORM_MODEL_TRANSFORM
      );
      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_POINT_SET],
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_POINT_SET],
        '../../../resources/wren/shaders/point_set.vert',
        '../../../resources/wren/shaders/point_set.frag'
      );
    }
  ...
  static shadowVolumeShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SHADOW_VOLUME]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_SHADOW_VOLUME
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SHADOW_VOLUME],
        Enum.WR_GLSL_LAYOUT_UNIFORM_MODEL_TRANSFORM
      );
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SHADOW_VOLUME],
        '../../../resources/wren/shaders/shadow_volume.vert',
        '../../../resources/wren/shaders/shadow_volume.frag'
      );
    }
  ...
  static skyboxShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SKYBOX]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_SKYBOX
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SKYBOX],
        Enum.WR_GLSL_LAYOUT_UNIFORM_TEXTURE_CUBE0
      );
      _wr_shader_program_use_uniform_buffer(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SKYBOX],
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SKYBOX],
        '../../../resources/wren/shaders/skybox.vert',
        '../../../resources/wren/shaders/skybox.frag'
      );
    }
  ...
  static smaaEdgeDetectionShader() {
    if (
      !WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SMAA_EDGE_DETECT_PASS]
    ) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_SMAA_EDGE_DETECT_PASS
      ] = _wr_shader_program_new();
      ...
      WbWrenShaders.buildShader(
        ...
        '../../../resources/wren/shaders/smaa_edge_detect.vert',
        '../../../resources/wren/shaders/smaa_edge_detect.frag'
      );
    }
  ...
  static smaaBlendingWeightCalculationShader() {
    if (
      !WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_SMAA_BLENDING_WEIGHT_CALCULATION_PASS
      ]
    ) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_SMAA_BLENDING_WEIGHT_CALCULATION_PASS
  ...
  static smaaFinalBlendShader() {
    if (
      !WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SMAA_FINAL_BLEND_PASS]
    ) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_SMAA_FINAL_BLEND_PASS
      ] = _wr_shader_program_new();
      ...
      WbWrenShaders.buildShader(
        ...
        '../../../resources/wren/shaders/smaa_final_blend.vert',
        '../../../resources/wren/shaders/smaa_final_blend.frag'
      );
    }
  ...
  static simpleShader() {
    if (!WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SIMPLE]) {
      WbWrenShaders.gShaders[
        WbWrenShaders.SHADER.SHADER_SIMPLE
      ] = _wr_shader_program_new();

      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SIMPLE],
        Enum.WR_GLSL_LAYOUT_UNIFORM_TEXTURE0
      );
      _wr_shader_program_use_uniform(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SIMPLE],
      ...
      WbWrenShaders.buildShader(
        WbWrenShaders.gShaders[WbWrenShaders.SHADER.SHADER_SIMPLE],
        '../../../resources/wren/shaders/simple.vert',
        '../../../resources/wren/shaders/simple.frag'
      );
    }
